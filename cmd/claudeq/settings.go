...
type settingsView struct {
	...
	ShowCodexBeta      bool   `json:"show_codex_beta"`
...
func printSettings(s store.Settings) {
	...
	// accepts a beta provider either way. Settings → Providers owns it.
	fmt.Printf("show_codex_beta:           %s (app only)\n", boolLabel(v.ShowCodexBeta))
